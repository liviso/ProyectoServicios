    ...
    stages {
       ...
       /* stage('Quality Gate'){
        ...
        stage('Testing') {
            steps {
                dir('cypress/') {
                    sh 'docker run --rm --name Cypress -v "C:/Users/cm_ol/Documents/CursoMicroservicios/Ecosistema Jenkins/jenkins_home/workspace/Pruebas/Cypress/cypress:/e2e -w /e2e" -e Cypress cypress/included:3.4.0'
                }
            }
        }
        stage('tar videos') 
